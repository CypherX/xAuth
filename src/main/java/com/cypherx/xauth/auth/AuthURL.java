 ...
 * I encourage you to implement the included 'Auth' interface and then use a single helper method to return an
 * appropriate instance of Auth for you to use.
 * author: moparisthebest
 */
public class AuthURL extends Auth {
    ...
    public AuthURL(final xAuth plugin, final String ipAddress) {
        this.plugin = plugin;
    ...
    public boolean online(String user) {
        if (!plugin.getConfig().getBoolean("authurl.status")) {
            //response = "AuthURL online is disabled.";
            return false;
        }
    ...
    public boolean offline(String user) {
        if (!plugin.getConfig().getBoolean("authurl.status")) {
            //response = "AuthURL offline is disabled.";
            return false;
        }
